angular.module('Autocomplete')
  .service('Offset', function(){
    return {
      dock_to: function(){} //External dependency
    }
  })
  .directive('asAutocomplete', ['$injector', function($injector){
    return {
      restrict: 'EAC',
      scope: {
        minLength: '@'
...
angular.module('Autocomplete').directive('asAutocompleteItem', ['$timeout', 'Offset', 'KeyCodes', function($timeout, Offset, KeyCodes){
  return {
    restrict: 'EAC',
...
angular.module('Autocomplete').directive('asAutocompleteInput', [function(){
  return {
    restrict: "EAC",
    require: '^asAutocomplete',
    link: function(scope, iElement, iAttrs, asAutocompleteCtrl){
